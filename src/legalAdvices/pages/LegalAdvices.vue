...
<script>
import LegalAdvicesServices from "../services/legalAdvices.service";
...
export default {
  ...
  methods: {
    ...
    retrieveLegalAdvices() {
      LegalAdvicesServices.getAll()
        .then(response => {
    ...
    deleteLegalAdvice(id) {
      LegalAdvicesServices.delete(id)
        .then(() => {
          this.refreshList();
        })
        .catch(e => {
