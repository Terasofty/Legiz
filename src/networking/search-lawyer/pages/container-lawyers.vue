      ...
      <v-row>
        <v-col v-bind:key="lawyer.id" v-for="lawyer in lawyers" cols="12" md="3">
          <v-card max-width="250" outlined class="mx-auto">
            ...
            <v-card-text
              ><v-rating :value="4.5" color="amber" dense half-increments readonly size="30"></v-rating
            ></v-card-text>
            <v-card-actions>
...
export default {
  ...
  data: () => ({
    ...
    district: null,
    lawyers: [],
    itemsSpecialization: ["Business Law", "Real State Law", "Civil Law", "Construction Law", "Elder Law"],
    itemsDistrict: ["Callao", "San Martin", "San Miguel", "Los Olivos", "Pueblo Libre"],
